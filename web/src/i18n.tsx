...
const translations = {
  zh: {
    ...
    authFailed: '认证失败，请重试',
    forgotPassword: '忘记密码？',
    getResetCode: '获取重置验证码',
    resetCode: '重置验证码',
    newPassword: '新密码',
    confirmPassword: '确认新密码',
    resetPassword: '重置密码',
    backToLogin: '返回登录',
    resetCodeGenerated: '验证码已生成，请在下方输入',
    resetCodeExpiresIn: '验证码有效期 10 分钟',
  ...
  en: {
    ...
    resetCodeGenerated: 'Reset code generated. Enter it below.',
    resetCodeExpiresIn: 'Code expires in 10 minutes',
